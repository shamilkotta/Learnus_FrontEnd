...
const Step2 = () => {
    ...
    return (
        <>
            <div class="form__module" id="form-step2-modules">

                <div className="form__input-group form__module-group">
                    <label for="course-module-1">Module moduleNo</label>
                    <MdDelete class="form__module-dlt-btn dlt-btn hover" title="Delete module" />
                    <InputText name="course-module-1" class="form-step2__module-name form__input" placeholder="Module name" required />

                    <div class="form-module__chapter" id="form__module-${moduleNo}-chapters">
                        ...
                        <MdDelete class="form-module__chapter-dlt-btn dlt-btn hover" title="Delete chapter" />
                    </div>
                    <button class="form-module__chapter-add-btn btn" onclick="addChapter(${moduleNo})"><FaPlus className="icon-vertical-align" /> Add Chapters</button>
                </div>
